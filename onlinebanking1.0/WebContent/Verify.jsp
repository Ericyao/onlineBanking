...
<body class="modern-ui" onresize="Resize()">
  ...
  <div class="page secondary fixed-header">
    <div class="page-header">
      ...
      <form class="form-horizontal" action = "SFTServlet" method="POST">
        <div id="maintain1">
          <% 

          String TDfromacct = request.getParameter("TDfromacct");
          double TDtime = 0;
          String TDrate = request.getParameter("TDrate");
          String TDamount = request.getParameter("TDamount");
          String TDStime = String.valueOf(TDtime);
          switch(Integer.parseInt(TDrate)){
          case 3: TDtime = 0.03;
          break;
          case 6: TDtime = 0.06;
          break;
        ...
        //request.setAttribute("transferfromnum",TDfromacct);
		//request.setAttribute("transferAmount",TDamount);
		//request.setAttribute("DepositTime",TDStime);

        %>
        <p class="input" name = "transferfromnum">FROM:</p>

        <p class="input" name = "DepositTime">RATE:</p>

        <p class="input">TIME:</p>

        <p class="input" name = "transferAmount">COUNT:</p>
      </div>

      <div id="maintain2" >
        <input type="text"  class="span4"  style="background-color: transparent;
        border: 0px; font-size: 20px;font-weight: bold;" name = "transferfromnum" value =<%=TDfromacct %> >
        <span class="help-block">  </span>

        <input type = "text" class="span4"  style="background-color: transparent;
        border: 0px; font-size: 20px;font-weight: bold;" name = "DepositTime" value =<%=TDtime %> >
        <span class="help-block">  </span>
        <input type = "text" class="span4"  style="background-color: transparent;
        border: 0px; font-size: 20px;font-weight: bold;" value = <%=TDrate %>>
        <span class="help-block">  </span>
        <input type="text" class="span4"  style="background-color: transparent;
        border: 0px; font-size: 20px;font-weight: bold;" name = "transferAmount" value=<%=TDamount %>>
